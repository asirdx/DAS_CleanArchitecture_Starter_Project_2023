...
public sealed class JwtProvider : IJwtProvider
{
    ...
    public async Task<LoginCommandResponse> CreateTokenAsync(User user)
    {
        ...
        user.RefreshTokenExpires = expires.AddMinutes(15); //expires normal tokenın 1 saatlik süresiydi. refresh token'ı 1.15 olarak ayarladık ki, normal token bittiğinde, refresh token ile yeni token alınabilsin.
